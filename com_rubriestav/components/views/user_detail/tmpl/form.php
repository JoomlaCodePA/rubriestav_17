...
<tr>
		<td valign="top" align="right" class="key" style="width:200px;text-align:right;">
			<label for="id_modules"><?php echo JText::_ ( 'Azienda' ); ?>: </label>
		</td>
		<td>
			<input class="text_area" type="hidden" name="azienda" id="azienda" size="60" value="<?php echo $this->detail->azienda; ?>" />
			 <?php echo ('<span style="font-weight:bold;font-size:1.2em;">'.$this->detail->azienda.'</span>');  ?>
		</td>
	</tr>
	<tr>
		<td valign="top" align="right" class="key" style="width:200px;text-align:right;">
	...
	<tr>
		...
		<td style="width: 350px;">
			<?php
				...
				echo ('<img src="components/com_rubriestav/images/email_famfamfam.gif"/>&nbsp;&nbsp;'."<a style='font-size:0.9em;' href='mailto:".$mailmia."'>".$mailmia."</a>");
			 ?>
		</td>
	</tr>
	...
	<tr>
		...
		?>: </label></td>
		<td >
			<?php echo ('<img src="components/com_rubriestav/images/phone.png"/>&nbsp;&nbsp;<span style="font-weight:bold;">('.$this->detail->voip.') '.$this->detail->tele_1_prefisso." - ".$this->detail->tele_1_numero.'</span>');  ?>
		</td>
	</tr>
	...
	<tr>
		...
		?>: </label></td>
		<td>
		<?php echo ('<img src="components/com_rubriestav/images/contatto_cell.gif"/>&nbsp;&nbsp;<span style="font-weight:bold;">'.$this->detail->tele_altri_numeri.'</span>');  ?>
		</td>
	</tr>
	...
	<tr>
		<td valign="top" align="right" class="key" style="width:200px;text-align:right;"><label for="id_modules"><?php
		echo JText::_ ( 'Sede Descrizione' );
		?>: </label></td>
		<td>
			<?php  echo $this->detail->sede_descrizione;  ?>
		</td>
	</tr>

	<tr>
		<td valign="top" align="right" class="key" style="width:200px;text-align:right;"><label for="id_modules"><?php
		echo JText::_ ( 'Sede Via' );
		?>: </label></td>
		<td><?php
		echo $this->detail->sede_via;
		?></td>
	</tr>

	<tr>
		<td valign="top" align="right" class="key" style="width:200px;text-align:right;"><label for="id_modules"><?php
		echo JText::_ ( 'Sede Citt&agrave;' );
		?>: </label></td>
		<td><span style="font-weight:bold;"><?php echo $this->detail->sede_citta; ?></span></td>
	</tr>
	
	<tr>
		<td valign="top" align="right" class="key" style="width:200px;text-align:right;"><label for="id_modules"><?php
		echo JText::_ ( 'Provincia' );
		?>: </label></td>
		<td><span style="font-weight:bold;"><?php echo $this->detail->sede_provincia; ?></span></td>
	</tr>
...
<tr>
		<td valign="top" align="right" class="key" style="width:200px;text-align:right;"><label for="id_modules"><?php
		echo JText::_ ( 'Da esterno' );
		?>: </label></td>
		<td>
			<?php echo ($this->note_numeri_esterni);?>
		</td>
	</tr>
...
<?php
		...
		if (!empty($this->detail->fototessera_url)){
			...
			$urlimage = 'components/com_rubriestav/images/nofoto.jpg';

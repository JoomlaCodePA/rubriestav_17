...
<h3 class="jpane-toggler title" id="1" style="font-size: 12px;"><span><?php
	echo JText::_ ( 'Ricerca Semplice' );
	?></span></h3>
<div class="jpane-slider content"
	style="background-color: white; margin-left: 20px;"><input type="text"
	name="search" id="search" value="<?php
	echo $ricerca?>"
	style="font-size: 1.2em; height: 25px; width: 500px;" onchange="sub();" />
...
if ($mode == 'semplice') {
	?> 
<div>
<p><i>Nota:</i> La ricerca semplice permette di ottenere una
...
<table class="adminlist"
	...
	<thead>
		<tr>
			...
			<th width="25%" nowrap="nowrap" class="title"
				...
				style="text-align: left;">
				<?php
				echo JHTML::_ ( 'grid.sort', 'Altri numeri', 'h.tele_altri_numeri', $this->lists ['order_Dir'], $this->lists ['order'] );
				?>
			</th>
	...
	for($i = 0, $n = count ( $this->items ); $i < $n; $i ++) {
		...
		<td>
			<?php echo $row->tele_altri_numeri; ?>
		</td>
		<td>
